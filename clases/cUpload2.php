<?PHP
	...
	abstract class cUpload2{

		public static function archivos($userfile_name, $userfile_size, $userfile_type, $userfile_tmp, $userfile_error, $cPath, $nNumero){ 
			...
			$allowed_image_types = array('image/pjpeg' => "jpg", 'image/jpeg' => "jpg", 'image/jpg' => "jpg", 'image/png' => "png", 'image/x-png' => "png", 'application/pdf' => "pdf", 'application/msword' => "doc", 'application/vnd.ms-excel' => "xls", 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' => "docx", 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' => "xlsx");                  
