<?PHP
	...
	$upload_path = "../imgProductos/";	// The path to where the image will be saved
	...
	$large_image_name =strtotime(date('Y-m-d H:i:s'));
	...
	if ($_POST["upload"]=="Upload") { 
		...
		if (strlen($error)==0){			
			if (isset($_FILES['image']['name'])){								
				...
				echo "success|".$large_image_location."|".($large_image_name.".".$file_ext)."|".$userfile_name;
			}
		}else{
			echo "error|".$error;
		}
